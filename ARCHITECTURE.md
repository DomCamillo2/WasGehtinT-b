...
`Cron oder manueller Trigger -> /api/external-events/refresh -> fetchExternalEvents() -> Scraper-Funktionen -> syncExternalEventsToCache() -> external_events_cache -> Discover`
